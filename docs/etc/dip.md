...
## DIP란?
### DIP
DIP는 객체지향 프로그래밍 원칙 중 하나인 __의존성 역전 원칙(Dependency Inversion Principle)__ 을 의미합니다. 이 원칙은 고수준 모듈이 저수준 모듈에 의존하지 않도록 하며, 그 대신에 둘 다 추상화에 의존하게 만드는 것을 목표로 합니다.<br/>
