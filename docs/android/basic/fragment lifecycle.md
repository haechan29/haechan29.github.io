...
4. onViewCreated(): 인플레이트된 뷰를 통해 추가 작업<sup>3</sup>을 수행한다. [해당 작업은 onCreateView()애서 수행하지 않는 것이 좋다.] [1]<br/>
5. onStart()<br/>
6. onResume()<br/>
7. onPause()<br/>
8. onStop()<br/>
9. onDestroyView(): Fragment 내부의 뷰에 대한 참조를 해제해야 한다<sup>4</sup>.<br/>
10. onDestroy()<br/><br/>
...
<sup>3</sup>뷰의 초기 상태 설정, LiveData 구독, RecyclerView 어댑터 설정 등.<br/>
<sup>4</sup>뷰 바인딩을 사용하는 경우 바인딩 객체에 대한 참조만 해제하면 된다.<br/>
